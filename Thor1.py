...
class ChatbotApp:
    ...
    def introduce(self):
        self.append_to_chat_window("Hello! I am Thor 🦸‍♂️, your university assistant chatbot.")
    ...
    def course_details(self):
        ...
        self.append_to_chat_window("2. How to select courses? 🗂️")
    ...
    def handle_course_sub_menu(self, user_input):
        if user_input == '1':
            ...
            self.append_to_chat_window("Contact your academic advisor to help you select courses. 🗂️")
        elif user_input == '3':
