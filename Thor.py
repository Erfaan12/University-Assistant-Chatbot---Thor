...
class ChatbotApp:
    ...
    def handle_enrollment_sub_menu(self, user_input):
        if user_input == '1':
            self.append_to_chat_window("To enroll, visit the university's enrollment page: https://www.stcloudstate.edu/apply/default.aspx")
            ...
            self.append_to_chat_window("The registration fee details can be found here: https://www.stcloudstate.edu/businessservices/student-services/cost-of-attendance.aspx")
        elif user_input == '4':
            self.current_topic = None
            self.introduce()
        else:
    ...
    def handle_course_sub_menu(self, user_input):
        if user_input == '1':
            self.append_to_chat_window("You can find the course catalog here: https://www.stcloudstate.edu/academics/default.aspx")
        elif user_input == '2':
            self.append_to_chat_window("Contact your academic advisor to help you select courses.")
        elif user_input == '3':
            self.append_to_chat_window("Course orientation sessions are announced here: https://www.stcloudstate.edu/advising/orientation/default.aspx")
        elif user_input == '4':
            self.current_topic = None
            self.introduce()
        else:
    ...
    def handle_financial_sub_menu(self, user_input):
        if user_input == '1':
            self.append_to_chat_window("Visit the financial aid office: https://www.stcloudstate.edu/financialaid/default.aspx")
            self.append_to_chat_window("Fill out the required forms available on their website.")
        elif user_input == '2':
            self.append_to_chat_window("Check the scholarships and grants information here: https://www.stcloudstate.edu/financialaid/types-of-aid/default.aspx")
        elif user_input == '3':
            self.append_to_chat_window("Tuition fees and payment options are detailed here: https://www.stcloudstate.edu/businessservices/default.aspx")
        elif user_input == '4':
            self.current_topic = None
            self.introduce()
        else:
    ...
    def handle_resources_sub_menu(self, user_input):
        if user_input == '1':
            self.append_to_chat_window("Access library resources online through the university library portal: https://www.stcloudstate.edu/library/")
        elif user_input == '2':
            self.append_to_chat_window("Visit the student health center or check their services here: https://www.stcloudstate.edu/medicalclinic/default.aspx")
        elif user_input == '3':
            self.append_to_chat_window("Career services offer job placement assistance. Visit their office or website for more info: https://www.stcloudstate.edu/careercenter/")
        elif user_input == '4':
            self.current_topic = None
            self.introduce()
        else:
    ...
    def handle_contact_sub_menu(self, user_input):
        if user_input == '1':
            self.append_to_chat_window("Admissions Office: scsu4u@stcloudstate.edu")
        elif user_input == '2':
            self.append_to_chat_window("Registrar's Office: registrar@stcloudstate.edu")
        elif user_input == '3':
            self.append_to_chat_window("Financial Aid Office: FinancialAid@StCloudState.Edu")
        elif user_input == '4':
            self.append_to_chat_window("Campus Resources: https://www.stcloudstate.edu/deanofstudents/campus-resources/default.aspx")
        elif user_input == '5':
            self.current_topic = None
            self.introduce()
        else:
